        ...
        if (res) {
          if (res.flag === false) router.push('/add');
            ...
            if (data) {
              ...
              // const avgSleep =
              // data.sleep.reduce((sum, itr) => sum + itr) / data.sleep.length;
              const avgStress =
                data.stress.reduce((sum, itr) => sum + itr) /
                data.stress.length;
              // console.log(avgSleep);
              console.log(avgStress);
              // setRest(avgSleep);
              setDepression(avgStress);
              setRecord(res);
            }
          }
        }
          ...
          <div className='flex flex-col basis-1/2 gap-6'>
            ...
            <div className='flex gap-6 h-[150px]'>
              ...
              <div className='p-4 basis-1/3 border-white border-2 rounded-xl'>
                ...
                <div className='pt-4 text-5xl font-light'>7 Hours</div>
              </div>
              <div className='p-4 basis-1/3 border-white border-2 rounded-xl'>
